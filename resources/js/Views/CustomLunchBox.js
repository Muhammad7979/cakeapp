...
const CustomLunchBox = withAlert(({ history, location, alert }) => {
    ...
    useEffect(() => {
        const fetchKitItems = async () => {
            try {
                const response = await axios.get('/lunchkititems');
                // console.log(response.data.items);
                setLunchData(response.data.items);
    ...
    useEffect(() => {
        console.log('Updated lunchdata:', lunchdata);
    }, [lunchdata]);
    ...
    const columns = useMemo(
        () => [
            ...
            { Header: 'Price', accessor: 'cost_price' },
    ...
    const submitForm = async (e) => {
        ...
        if (cartItems.length <= 0) {
        ...
        else if (boxinfo.boxname == "") {
            alert.error("Please enter box name");

        }
        else if (boxinfo.boxdescription == "") {
            alert.error("Please box description");
        }
        else {
            // const {
            //     productId,
            ...
            try {
                ...
                data.append('boxname', boxinfo.boxname);
                data.append('boxdescription', boxinfo.boxdescription);
                //     let _temp = "";
                ...
                console.log(data)
                let result = await axios.post('/lunchkititems/save', data);
                ...
                if (result.status > 200) {
                    ...
                    if (result.data.status == "Success") {
                        ...
                        setSelectAll(false);
                        console.log("Success");
                        setBoxInfo({ boxname: '', boxdescription: '' });
            ...
            <div id="wrapper">
                ...
                <section id="body">
                    <div className="inner_container">
                        <div className="place_order_container d-flex clearfix">
                                    ...
                                    <div className="container mt-4">
                                        <div className='mb-5 d-flex'>
                                            <div className='flex-grow-1'>
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Enter lunch box name"
                                            ...
                                            <div className='flex-grow-1'>
                                                ...
                                                <input
                                                    ...
                                                    name='boxdescription'
                                                    onChange={handleChange}
                                                    value={boxinfo.boxdescription}

                                                    placeholder="Enter lunch box description"
                                        ...
                                        {loading ? (
                                            ...
                                            <div>
                                                ...
                                                <div className=" py-3  d-flex mb-3 align-items-center">
                                                    <div className="flex-grow-1">
                                                        <input
                                                            type="text"
                                                            value={filterName}
