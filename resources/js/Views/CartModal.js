...
const CartModal = ({ cartItems, removeItem, handleClose, handleQuantity }) => {
    // State for managing quantity values
    ...
    const updateQuantity = (itemId, newQuantity) => {
        ...
        handleQuantity(newQuantity, cartItems.find(item => item.item_id === itemId));
    };
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <button type="button" className="btn-close" onClick={handleClose}><span>x</span></button>
                    </div>
