            ...
            <div style="margin: auto;">
                <table width="100%"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <b>Cake Message</b> : {{$order->remarks}}
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                    ...
                    <tfoot>
                        <tr>
                            <td style="width: 63%;"><b>Cake Instructions</b> : {{$order->instructions}}</td>
                            <td align="left">Total</td>
                            <td align="left" class="gray">{{$order->total_price}} (Rs)</td>
                        </tr>
                        @if($order->discount>0)
                        <tr>
                            <td colspan="1"></td>
                        ...
                        <tr>
                            <td colspan="1"></td>
                            <td align="left">Balance</td>
                            <td align="left" class="gray">{{$order->total_price - $order->advance_price-$order->discount}}
                                (Rs)</td>
                        </tr>
                        <tr class="spaceUnder">
                            <td colspan="1"></td>
